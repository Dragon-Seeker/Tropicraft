...
public class Ingredient implements Comparable<Ingredient> {
    ...
    public Ingredient(int id, @NotNull Supplier<? extends ItemLike> ingredientItem, boolean primary, int color) {
    ...
    public Ingredient(int id, @NotNull Supplier<? extends ItemLike> ingredientItem, boolean primary, int color, float alpha) {
    ...
    public static Ingredient findMatchingIngredient(@NotNull ItemStack stack) {
