...
public class TropicraftItemModelProvider extends ItemModelProvider {
    ...
    protected void registerModels() {
        ...
        for (FurnitureItem<UmbrellaEntity> umbrellaItem : TropicraftItems.UMBRELLAS.values()) {
        ...
        for (FurnitureItem<ChairEntity> chairItem : TropicraftItems.CHAIRS.values()) {
        ...
        for (FurnitureItem<BeachFloatEntity> beachFloatItem : TropicraftItems.BEACH_FLOATS.values()) {
        ...
        for (CocktailItem cocktailItem : TropicraftItems.COCKTAILS.values()) {
        ...
        TropicraftItems.ASHEN_MASKS.values().forEach((b) -> generated(() -> b));
        ...
        // Discs
        TropicraftItems.MUSIC_DISCS.values().forEach((b) -> generated(() -> b));
